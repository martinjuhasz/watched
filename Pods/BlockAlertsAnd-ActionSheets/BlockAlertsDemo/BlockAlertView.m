...
#define kAlertFontColor    [UIColor whiteColor]
...
+ (void)initialize
{
    if (self == [BlockAlertView class])
    {
        ...
        buttonFont = [[UIFont boldSystemFontOfSize:14] retain];
    }
}
...
- (void)addComponents:(CGRect)frame {
    if (_title)
    {
        ...
        labelView.shadowColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.8f];
...
- (void)show
{
    ...
    for (NSUInteger i = 0; i < _blocks.count; i++)
    {
        ...
        UIImage *imageActive = [UIImage imageNamed:[NSString stringWithFormat:@"alert-%@-button-selected.png", color]];
        imageActive = [imageActive stretchableImageWithLeftCapWidth:(int)(imageActive.size.width+1)>>1 topCapHeight:0];
        ...
        button.titleLabel.shadowColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.8f];
        ...
        [button setTitleShadowColor:[UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.8f] forState:UIControlStateNormal];
